$(document).ready(function() {
  ...
  '2~Bitfinex~LTC~USD', '2~Bitfinex~XRP~USD', '2~Bitfinex~XMR~USD', '2~Coinbase~BCH~USD',
  ...
  var flashChange = function() {
      $("#Coinbase_BTC").removeClass("demo");
        setTimeout(function() {
        $("#Coinbase_BTC").addClass("demo");
    }, 1);
  };
